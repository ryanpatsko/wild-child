...
const Contact = () => {
  ...
  return (
    <div className="page-container">
      ...
      <p className="intro-text">{contact.introText}</p>
      
      <div className="contact-buttons">
        <a href={contact.instagramUrl} target="_blank" rel="noopener noreferrer" className="contact-btn instagram-btn">
          ...
          <span className="btn-text">{contact.instagramButtonText}</span>
        </a>
        <a href={contact.venmoUrl} target="_blank" rel="noopener noreferrer" className="contact-btn venmo-btn">
          <svg className="btn-icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/>
          </svg>
          <span className="btn-text">{contact.venmoButtonText}</span>
        </a>
      </div>
      ...
      <div className="contact-info-banner">
        <p className="contact-info-text">
          {contact.infoPrefix}{' '}
          <a href={`mailto:${contact.infoEmail}`} className="contact-info-link">
            {contact.infoLinkText}
          </a>
          {contact.infoMiddleText} <strong>{contact.infoPhone}</strong> {contact.infoSuffix}
        </p>
      </div>
