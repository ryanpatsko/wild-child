...
const BridalAtlanta = () => {
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', 'Professional bridal hair and makeup packages in Atlanta, GA. Wild Child Fabrications offers luxury beauty services for your wedding day. Book your bridal trial today!');
  }, []);
