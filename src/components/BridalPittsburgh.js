...
const BridalPittsburgh = () => {
  ...
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', 'Professional bridal hair and makeup services in Pittsburgh, PA. Wild Child Fabrications offers luxury beauty services for your wedding day. Book your bridal trial today!');
    ...
    geoRegion.setAttribute('content', 'US-PA');
    ...
    geoPlacename.setAttribute('content', 'Pittsburgh');
    ...
    geoPosition.setAttribute('content', '40.4406;-79.9959');
    ...
    ogTitle.setAttribute('content', 'Bridal Hair & Makeup in Pittsburgh, PA | Wild Child Fabrications');
    ...
    ogDescription.setAttribute('content', 'Professional bridal hair and makeup services in Pittsburgh, PA. Book your wedding beauty services today!');
    ...
    canonical.setAttribute('href', 'https://wildchildfabrications.com/bridal-pittsburgh');
  }, []);
