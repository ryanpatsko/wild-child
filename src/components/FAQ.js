    ...
    <div className="page-container">
      ...
      <section className="section-card">
        <div className="faq-item">
          <h3 className="feature-title">What are your business hours to get a hold of you?</h3>
        ...
        <div className="faq-item">
          <h3 className="feature-title">How do I pay my retainer and/or booking fees?</h3>
          <p className="faq-answer">Those can be made via Venmo only. The username is @ChristaleeHMUA. For convenience, we have a link to that on our site! Please do not send retainer/booking payments before discussion with the artist so that we can create a contract for your event date beforehand.</p>
        </div>

        <div className="faq-item">
          <h3 className="feature-title">Where is my appointment located?</h3>
        ...
        <div className="faq-item">
          <h3 className="feature-title">How should I prep for my appointment?</h3>
        ...
        <div className="faq-item">
          <h3 className="feature-title">Can I bring someone to my trial or appointment at your studio?</h3>
        ...
        <div className="faq-item">
          <h3 className="feature-title">Do I have to book you for both hair AND makeup since you offer both?</h3>
        ...
        <div className="faq-item">
          <h3 className="feature-title">Bridal party pricing - hidden fees?</h3>
        ...
        <div className="faq-item">
          <h3 className="feature-title">What about men, they/them / non-binary or transitioning client needs?</h3>
